...
const en: Translations = {
  ...
  settings: {
    ...
    boutique: {
      name:        'Shop name',
      address:     'Address',
      addressAuto: 'Detect my location',
      addressHint: 'Leave empty and Legwan will auto-detect your location.',
      phone:       'Phone',
  ...
  policy: {
    ...
    scrollHint:'Please read the entire privacy policy to continue.',
